...
import image from "../../images/Avinash_Parashkar.jpg";
import Modal from "@mui/material/Modal";
import Box from "@mui/material/Box";

import Prof_7_details from "../faculties_details/Prof_7";
  ...
  return (
    <>
      <div>
        ...
        <div className="card-title"> Avinash Parashar</div>
        ...
        <div className="faculty-name"> avinash.parashar@me.iitr.ac.in</div>
        <div className="faculty-heading research"> Research fields </div>
        <div className="faculty-name">
          {" "}
          Composites, Nanocomposites, FEM, Fracture Mechanics, damage mechanics,
          Continuum Mechanics, Nanomechanics, Graphene, CNT, h-BN nanosheets,
          nuclear materials{" "}
        </div>
        {/* <ul>

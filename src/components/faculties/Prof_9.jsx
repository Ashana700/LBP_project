...
import image from "../../images/ashish_yadav.jpg";
import Modal from "@mui/material/Modal";
import Box from "@mui/material/Box";

import Prof_9_details from "../faculties_details/Prof_9";
  ...
  return (
    <>
      <div>
        ...
        <div className="card-title"> Ashish Yadav</div>
        ...
        <div className="faculty-name"> ashish@ch.iitr.ac.in </div>
        <div className="faculty-heading research"> Research fields </div>
        <div className="faculty-name">
          {" "}
          Renewable Energy, Electrochemical Energy Storage and Conversion,
          Sustainable Hydrogen and Fuel Cell Technology, Electrochemical and
          Chemiresistive Sensors, Carbon Nanomaterials, Microbial
          Electrochemical Systems, Wastewater Treatment,{" "}
        </div>
        {/* <ul>

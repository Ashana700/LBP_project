...
import Card_image1 from "../../images/hiral.jpg";
    ...
    <>
      <div>
        ...
        <div className="card-description">
          {" "}
          Electricity issues, frequent power cuts Bad roads, that damages the
          items during transportation hence increase the cost .
        </div>
